                            ...
                            if (ResJSON[1].length > 0) {
                                for (let i = 0; i < ResJSON[1].length; i++) {
                                    ...
                                    if ($("#stream-season").length > 0) {
                                        ...
                                        SeasonAllEpisodes += "'><span  class='episode' episode='" + ResJSON[1][i].episode + "'>Episode " + ResJSON[1][i].episode + "</span><span><i class=\"gg-eye-alt add-to-watched\"></i></span><span>" +
                                            ResJSON[1][i].name + "</span><span class='showName' showName='" + seriesSelect + "'>" + JSONData.showName + "</span><span class='season'>" + ResJSON[1][i].season + "</span></a>"
